...
const bidDueDateRoute = express.Router();


bidDueDateRoute.route('/').get((req, res) => {
  if (req.session.userId ) {
    ...
    connection.query(
      'SELECT Id, Bid_Due_Date__c, Name FROM Opportunity WHERE SOPS_Control__c = True ' +
...
module.exports = bidDueDateRoute;
